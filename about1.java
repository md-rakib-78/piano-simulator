...
///////////// Back Button
ImageIcon icon43 = new ImageIcon(new ImageIcon("image/forB03.png")
        .getImage().getScaledInstance(resizedWidth, resizedHeight, Image.SCALE_SMOOTH));
ImageIcon pressedIcon43 = new ImageIcon(new ImageIcon("image/forB04.png")
        .getImage().getScaledInstance(resizedWidth, resizedHeight, Image.SCALE_SMOOTH));

f1 = new JButton(icon43);
f1.setBounds(50, screenH-resizedHeight-80+30, resizedWidth, resizedHeight);
...
f1.addMouseListener(new MouseAdapter() {
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        /// First page
        ImageIcon originalIcon = new ImageIcon("image/ss03.png");
